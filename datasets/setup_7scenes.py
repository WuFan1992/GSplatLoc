...
if __name__ == '__main__':
    ...
    #for ds in ['chess', 'fire', 'heads', 'office', 'pumpkin', 'redkitchen', 'stairs']:  # FanWU: In our case, only the chess is used 
    for ds in ['chess']:
            ...
            for seq in split:
                ...
                for d_file in depth_files:
                    ...
                    if opt.poses == 'pgt':
                        ...
                        #################################################
                        key = seq + "/" +  dutil.get_base_file_name(d_file)
    ...
    #    map(delayed(process_scene), ['chess', 'fire', 'heads', 'office', 'pumpkin', 'redkitchen', 'stairs']))  # FanWU: we only use chess
    process_scene('chess')
