...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    feature_extractor = FeatureExtractor("r2d2") 
    ...
    bg_color = [1]*feat_dim if dataset.white_background else [0]*feat_dim
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        gt_feature_map = feature_extractor(gt_image[None])["feature_map"][0]
