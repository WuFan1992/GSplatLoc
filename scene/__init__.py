    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=False, resolution_scales=[1.0], load_gaussian=True): 
        ...
        if load_gaussian:
            if self.loaded_iter:
                ...
                self.gaussians.create_from_pcd(scene_info.point_cloud, self.cameras_extent, 128, args.speedup) 

    def save(self, iteration):
        point_cloud_path = os.path.join(self.model_path, "point_cloud_r2d2/iteration_{}".format(iteration))
